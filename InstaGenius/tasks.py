    ...
    def product_analysis(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Detailed analysis report highlighting key features and suggestions."
        )
    ...
    def competitor_analysis(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Detailed analysis report comparing the product with its top 3 competitors."
        )
    ...
    def campaign_development(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Marketing campaign plan including strategy and creative content ideas."
        )
    ...
    def instagram_ad_copy(self, agent):
        return Task(
            description=dedent("""\
                ...
                """),
            agent=agent,
            expected_output="Three options for engaging Instagram ad copy."
        )
    ...
    def take_photograph_task(self, agent, copy, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three options of photographs with descriptive paragraphs."
        )
    ...
    def review_photo(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three reviewed options of photographs with descriptive paragraphs."
        )
